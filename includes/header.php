...
a.forgotpw:hover{
  ...
  div#w-dropdown-toggle-2, .padzero {
    padding: 0px;
}
    ...
    .column-30.w-col.w-col-4,.column-31.w-col.w-col-4,.column-32.w-col.w-col-4 {
    border-radius: 5px;
    margin-bottom: 15px;
    margin-right: 0;
    padding: 20px 25px;
...
.column-30.w-col.w-col-4:hover,.column-31.w-col.w-col-4:hover,.column-32.w-col.w-col-4:hover{
  box-shadow: none;
}
...
.post-a-job-new-input:focus , .post-a-job-new-input:focus-visible{
    color: #495057;
...
.category-slider .owl-prev i, .category-slider .owl-next i {
...
.category-slider button.owl-next,.category-slider button.owl-prev {
    overflow: hidden;
    padding: 0!important;
    margin: 0!important;
}
...
a.button-2-rdm.login.w-button.nwhd.chred, a.button.cc-contact-us.custom-hd.w-inline-block.nwhd.chred {
    line-height: 21px;
	    padding: 8px 8px;
}
...
.w-dropdown-toggle.w--open .w-icon-arrow-down:before, .w-dropdown-toggle.w--open .w-icon-dropdown-toggle:before {
    color: #006bf5;
...
.w-dropdown-toggle:hover .w-icon-dropdown-toggle:before,.w-dropdown-toggle:hover .text-block-2,.w-dropdown-toggle.w--open .text-block-2 {
    color: #006bf5;
}
.modal-backdrop {
    opacity: 1!important;
