  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal(
          "Register!",
          "You are registered successfully, please take assesment test on your profile by selecting the category you want!",
          "success"
        ).then((value) => {
      ...
      if (data.trim() == "true") {
        ...
        $("#NewSignupForm").append(`
                    <form id="signup_user1">
                        ...
                        <div class="post-a-job-continue-btn-div pt-4"><button type ='button' class="continue-btn3 post-a-job-continue-btn btn-block text-white text-center text-decoration-none rounded" id="signu_btn1">Submit</button></div>
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.success == "yes") {
          swal(
            "Success",
            "We send phone verification code on your phone number",
            "success"
          ).then((value) => {
          ...
          swal(
            "Failed",
            "Failed to send verification code, please click resend button.",
            "error"
          );
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        ...
        ajax_data.append("city", $("#city").val());
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (data.trim() == "true") {
              ...
              swal(
                "Failed to post job",
                "Job not posted kindly try again",
                "error"
              );
            }
            $("#signu_btn1").attr("disabled", false);
        ...
        swal(
          "Email Already Registered",
          "You are already a member, Kindly login",
          "info"
        ).then((value) => {
        ...
        $.ajax({
          ...
          success: function (data) {
            if (data.trim() == "true") {
              swal(
                "Profile Updated",
                "You are profile updated successfully!",
                "success"
              ).then((value) => {
              ...
              swal(
                "Not Updated",
                "Your profile not updated try again",
                "error"
              );
            }
          },
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        ...
        swal(
          "Not Updated",
          "Your Working area not updated, try again!",
          "error"
        );
      }
    },
...
$("#login-form").submit(function (event) {
  ...
  if ($("#email").val() == "" || $("#pass").val() == "") {
    swal(
      "Missing details",
      "Enter Email and Password,kindly try again",
      "error"
    );
    return;
  }
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (data.trim() == "true") {
              ...
              swal(
                "Job Not Posted",
                "Your job is not posted, kindly try again",
                "error"
              );
            }
          },
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal(
          "Recover Password",
          "We've sent recover token on your email!",
          "success"
        ).then((value) => {
...
$("#post_job").submit(function (event) {
  ...
  if ($("#title").val() == "") {
    swal(
      "Job Posting",
      "Error - Job post code missing. Please provide the required information to post a job.",
      "info"
    );
    $("#title").focus();
    return;
...
$("#main_service_form").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("Add Successfully", "Your service added", "success").then(
          (value) => {
            $("#mainareaForm").hide();
            location.reload();
            $("#area_name").val("");
...
$("#mian_category_form").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("Add Successfully", "Your Category added", "success").then(
          (value) => {
...
$("#addblogcat").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("", "Blog Category added successfully", "success").then(
          (value) => {
            $("#optionsForm").hide();
            location.reload();
            $("#blog_cat_name").val("");
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.trim() == "false") {
        swal(
          "Not Found ",
          "Not found any sub category for this main category",
          "error"
        ).then((value) => {});
      } else {
        if (mydata.length == 0) {
...
$("#questionform").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("Add Successfully", "Your Question added", "success").then(
          (value) => {
            // location.reload();
...
$("#editquestionform").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("Edit Successfully", "Your Question Edit", "success").then(
          (value) => {
            location.reload();
          }
        );
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.trim() == "false") {
        swal(
          "Not Found ",
          "Not found any sub category for this mian category",
          "error"
        ).then((value) => {});
      } else {
...
$("#apply_job").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      let button = $(
          ".single-lead-desc-first-sec-loc-address .btn-div-general.my-auto.mr-2"
        ),
        appliedbtn =
          '<a class="btn-bg-general tooltip-show btn-block text-white text-center px-3 py-2 text-decoration-none font-weight-bold rounded" style="padding-bottom: .3rem !important;padding-top: .3rem !important;">Already applied</a>';

      if (data.trim() == "already-apply") {
        swal(
          "Already Applied",
          "You have alerady applied in this job, Please apply on another job.",
          "info"
        ).then((value) => {
        ...
        swal(
          ...
          "Thank you for applying! Your message is now on its way to the customer.",
          "success"
        ).then((value) => {
          $("#exampleModal").modal("hide");
        });
      ...
      success: function (data) {
        ...
        if (data.trim() == "true") {
          ...
          if ($("#isphoneverifiy").val() == 0) {
            swal(
              "Alert",
              "Your phone is not verified, verify it to continue ",
              "error"
            ).then((value) => {
              $("#verifiymodal").modal("show");
              return;
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if (data.trim() == "true") {
                ...
                swal(
                  "Not registered",
                  "Your are not registered, try again",
                  "error"
                );
              }
            },
...
$("#rateUser").submit(function (event) {
  ...
  let stars_q2 = $("input[name='rating_q2']:checked").val();
  let stars_q3 = $("input[name='rating_q3']:checked").val();
  ...
  ajax_data.append("stars_q2", stars_q2);
  ajax_data.append("stars_q3", stars_q3);
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data.trim() == "true") {
            swal(
              "Feedback Submitted",
              "Thank you for submitting your review. Your feedback is greatly appreciated.",
              "success"
            ).then((value) => {
              location.reload();
            });
...
$("#updateSettings").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("Updated", "Settings updated successfully!", "success").then(
          (value) => {
            location.reload();
          }
        );
...
$("#uploadImages").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("Uploaded Successfully", "Your gallery uploaded", "success").then(
          (value) => {
            location.reload();
          }
        );
...
$(".upload__inputfile").change(function (event) {
  ...
  if (totalfiles == 0) {
    swal(
      "Select Image",
      "Please select an image/video and try again ",
      "error"
    );
    return;
  }
...
function editjobsetSubCategory() {
  ...
  if (selectedID == "not-determined") {
    swal("Select Category", "Please Select mian category", "info").then(
      (value) => {
        location.reload();
      }
    );
      ...
      if (qualifications.length > 0) {
        ...
        for (var i = 0; i < qualifications.length; i++) {
          ...
          for (var j = 0; j < items.length; j++) {
            var newInput = $(
              '<div class="qualification"><input type="text" class="form-control-lg form-control" required="" name="qualification[]"><button type="button" class="remove-qualification btn btn-danger">-</button></div>'
            );
...
$("#reactivate_account").click(function (e) {
  ...
  $.ajax({
    ...
    success: function (data) {
      var mydata = JSON.parse(data);
      if (data.trim() == "false") {
        swal("Not Found ", "Not found any category", "error").then(
          (value) => {}
        );
      } else {
        ...
        if (data.trim() == "false") {
          ...
          for (let i = 0; i < mydata.length; i++) {
            if (maincateogrycheck != mydata[i].main_category) {
              $("#scrolling-wrapper").append(
                `<h6 class="mt-3">${mydata[i].main_category}</h6>`
              );
            }
            maincateogrycheck = mydata[i].main_category;
            if (
              !mydata[i].sub_category.includes("Other") &&
              !mydata[i].sub_category.includes("other")
            ) {
              $("#scrolling-wrapper").append(`
...
$("#verifiy_btn").click(function (e) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.trim() == "true") {
        $("#isphoneverifiy").val(1);
        swal("Success", "Your phone is verified successfully", "success").then(
          (value) => {}
        );
      } else {
        $("#isphoneverifiy").val(0);
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal(
          "Success",
          "We send message on your mobile number ",
          "success"
        ).then((value) => {
          location.reload();
        });
        ...
        swal(
          "",
          "Phone number is not found, Check your phone number, and try again!",
          "error"
        );
      } else {
        swal("Not Submit", "Kindly Resubmit", "error");
...
$("#addBlog").submit(function (event) {
  ...
  if (user_category == "Professionals") {
    ajax_data.append(
      "blog_category",
      $("#tradespeople_category option:selected").val()
    );
  } else {
    ajax_data.append(
      "blog_category",
      $("#home_owners_category option:selected").val()
    );
  }

  ajax_data.append(
    "select_main_category",
    $("#select_main_category option:selected").val()
  );
  ...
  $.ajax({
    ...
    success: function (data) {
      console.log(data);
      if (data.trim() == "true") {
        swal("success", "Blog submit successfully!", "success").then(
          (value) => {
            location.reload();
          }
        );
  ...
  swal({
    ...
    if (willDelete) {
      $.ajax({
        ...
        success: function (data) {
          if (data.trim() == "true") {
            swal("success", "Blog has been deleted", "success").then(
              (value) => {
                location.reload();
              }
            );
...
$("#editBlog").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        swal("success", "Blog update successfully!", "success").then(
          (value) => {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data.trim() == "true") {
            swal(
              "Success",
              "Blog notification send successfully",
              "success"
            ).then((value) => {});
          } else {
...
$("#electrical_certification").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.trim() == "true") {
        swal("Certifications uploaded  successfully", "", "success").then(
          (result) => {
            window.location.href =
              "quiz?main_Category_id=" + category_id + "&ajax=1";
          }
        );
      } else if (data.trim() == "<3") {
        swal("Please upload at least 3 documents", "", "info").then(
          (value) => {}
        );
      } else {
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.trim() == "true") {
        ...
        swal(
          "",
          "This gas safe registration number is already registered on our site. Please contact us if you require assistance",
          "info"
        );
      } else {
        swal("", "Failed to upload certifications", "error");
    ...
    if (willDelete) {
      ...
      $.ajax({
        ...
        success: function (data) {
          console.log(data);
          if (data.trim() == "true") {
            swal("Success", "Verify successfully", "success").then((value) => {
