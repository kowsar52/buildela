        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="editBlog">
                            <input value="<?=$blog['id']?>" id="blog_id" type="hidden">
                            <div class="row">
                                <div class=" col-6  form-group input_parent">
                                    <label>Title: </label>
                                    <input class="form-control"  value="<?=$blog['title']?>" required type="text" id="title" >
                                </div>

                                <div class=" col-6 form-group input_parent">
                                    <label>Author name:</label>
                                    <input class="form-control" required value="<?=$blog['author_name']?>" type="text" id="author" >
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class=" col-4  form-group input_parent" >
                                    ...
                                    <select class="form-control tradespeople_cat" name="tradespeople_category" id="tradespeople_category">
                                        <?php
                                        foreach($blogCategory as $main){
                                ...
                                <div class=" col-4  form-group input_parent" >
                                    ...
                                    <input class="form-control" value="<?=$blog['create_date']?>"  required  type="date" id="publish_date">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 form-group input_parent">
                                    ...
                                    <textarea class="form-control" type="text"  rows="4" id="short_description" ><?=$blog['short_description']?></textarea>
                                </div>
                            ...
                            <div class="text-center my-2">
                                <button class="btn btn-success" type="submit" id="blog_btn">Update</button>
                            </div>
                        </form>
                    </div>
...
<script>
    $("#category1").val(`<?=$blog['category']?>`);

    if(`<?=$blog['category']?>`=="Professionals"){
        $("#category_div").show();
        $("#home_owners_category").hide();
        $("#tradespeople_category").val(`<?=$blog['blog_category']?>`);
    }else {

        $("#category_div").hide();
        $("#home_owners_category").val(`<?=$blog['blog_category']?>`);
        $("#tradespeople_category").hide();
    }


    $("#select_main_category").val(`<?=$blog['job_category']?>`);

    var d=`<?=$blog['long_description']?>`;

    setTimeout(() => {
        tinymce.get("long_description").setContent(d);
    }, "5000")
