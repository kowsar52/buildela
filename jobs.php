    ...
    function counterCheck(){
        ...
        $.ajax({
            ...
            success: function (response) {
                    ...
                    if(fixingUnread() === 'newleads') $('#unreadcounter').text(data.leads.unread);
                    if(fixingUnread() === 'interested') $('#unreadcounter').text(data.interested.unread);
                    if(fixingUnread() === 'shortlisted') $('#unreadcounter').text(data.shortlisted.unread);
                    if(fixingUnread() === 'jobswon') $('#unreadcounter').text(data.hired.unread);
